...
const EXPERIENCE_ITMES: ExperienceItem[] = [
  ...
  },
  {
    ...
    diagrams to aid in design clarity. I designed the PostgreSQL database with normalization principles for efficiency, 
    developed the backend using Django with MVC architecture, 
